...
function! s:Gt()
	...
	if ext == 'php'
		let vimp = vimp.'phpGetterAndSetter.pyc'
	elseif ext == 'java'
		let vimp = vimp.'javaGetterAndSetter.pyc'
	else
		let vimp = ''
	endif
...
function! s:Gs()
	:w
	let fn = bufname()
	let vimp = Nvim().'/python/GetterAndSetter/getterAndSetter.pyc'
...
function! s:AutoComplete()
	let ext = ''.expand('%:e')
	let co = 'python '.Nvim().'/python/autocomplete/autocomplete.pyc --ext "'.ext.'"'
...
function! s:FullAutoComplete()
	let ext = ''.expand('%:e')
	let co = 'python '.Nvim().'/python/autocomplete/autocomplete.pyc --ext "'.ext.'" --noexit'
	let result = system(co)
	let g:dict = g:dict.result
	let result = split(result)	
	for n in result
...
function! s:GetDict()	
	let co = 'python '.Nvim().'/python/autocomplete/getAll.pyc'
	let result = system(co)
	let g:dict = g:dict.result	
endfunction

function! s:GetFullDict()	
	let co = 'python '.Nvim().'/python/autocomplete/getAll.pyc --noexit'
	let result = system(co)
	let g:dict = g:dict.result	
endfunction
...
function! s:AddPackage()
	let ext = ''.expand('%:e')
	let co = 'python '.Nvim().'/python/package/addPackage.pyc '.ext.' "'.getline('.').'"'
	let result = system(co)
endfunction
...
function! s:ToFile()
	let dn = ''.expand('%:p:h')
	let co = 'python '.Nvim().'/python/writer/write.pyc '.Nvim().'/.current '.dn 
	"echo co
	let res = system(co)	
	:execute 'cd '.dn
	pwd
